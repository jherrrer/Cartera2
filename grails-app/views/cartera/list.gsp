...
<html>
	...
	<body>
		<a href="#list-cartera" class="skip" tabindex="-1"><g:message code="default.link.skip.label" default="Skip to content&hellip;"/></a>
		...
		<div id="list-cartera" class="content scaffold-list" role="main">
			...
			<table>
				...
				<tbody>
				<g:each in="${carteraInstanceList}" status="i" var="carteraInstance">
			...
			<div class="pagination">
				<g:paginate total="${carteraInstanceTotal}" />
			</div>
		</div>
	</body>
</html>
